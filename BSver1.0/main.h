...
#define WAIT_TIMEOUT	10	//время ожидания запроса статуса от ИНК-Б
#define CPU_FREQ			20000000
#define RS232_BAUD		9600
#define DOSE_TO_HOUR	0.0002778//2.78e-4	//коэф. пересчета дозы
/*
Для загрузчика - порядковый номер устройства, означает индекс контроллера (для блоков включающих в себя несколько МК).
*/
...
*/
//#define ISOLATE						//отключение выполнения основной программы
#define DEBUG_MSG_ENABLE		//отправка отладочных сообщений
#define DEBUG_BDSP_40ZERO			//зануляем 40 первых каналов спектрометра

extern const uint32	SerialNumberBD;

//режим рассчёта круговой диаграммы
typedef enum
{
	SPEC_MODE = 0x01,	//рассчёт по данным спектрометра
	CNTR_MODE = 0x02	//рассчёт по данным 'гранаты'
}eAngDiagrammMode;

//статусы калибровки
typedef enum
{
	ZERO_BALANCING_I				= 0x01,
	ZERO_BALANCING_II				= 0x02,
	ZERO_BALANCING_III 			= 0x03,
	ZERO_BALANCING_IV 			= 0x04,
	ENERGY_SCALE_ROUGH_I		= 0x05,
	ENERGY_SCALE_ROUGH_II		= 0x06,
	ENERGY_SCALE_ROUGH_III	= 0x07,
	ENERGY_SCALE_ROUGH_IV		= 0x08,
	ENERGY_SCALE_FINE_I			= 0x09,
	ENERGY_SCALE_FINE_II		= 0x10,
	ENERGY_SCALE_FINE_III		= 0x11,
	ENERGY_SCALE_FINE_IV		= 0x12,
	STAB_SCALE_ROUGH_I			= 0x13,
	STAB_SCALE_ROUGH_II			= 0x14,
	STAB_SCALE_ROUGH_III		= 0x15,
	STAB_SCALE_ROUGH_IV			= 0x16,
	STAB_SCALE_FINE_I				= 0x17,
	STAB_SCALE_FINE_II			= 0x18,
	STAB_SCALE_FINE_III			= 0x19,
	STAB_SCALE_FINE_IV			= 0x20,
	CALIBRATION_SUCCESS_I		= 0x21,
	CALIBRATION_SUCCESS_II	= 0x22,
	CALIBRATION_SUCCESS_III	= 0x23,
	CALIBRATION_SUCCESS_IV	= 0x24
}eCalibrationStatus;

